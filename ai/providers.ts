...
export const scira = customProvider({
  languageModels: {
    ...
    'scira-haiku-free': anthropic('claude-3-5-haiku-20241022'),
    'scira-mistral-free': mistral('mistral-medium-2508'),
    'scira-cohere-free': cohere('command-a-03-2025'),
    'scira-kimi-free': isValidApiKey(process.env.GROQ_API_KEY) ? groq('moonshotai/kimi-k2-instruct-0905') : google('gemini-2.5-flash'),
...
export const models: Model[] = [
  ...
  {
    value: 'scira-haiku-free',
    label: 'Claude 3.5 Haiku (Free)',
    description: "Anthropic's fastest model - Free tier",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-mistral-free',
    label: 'Mistral Medium (Free)',
    description: "Mistral's balanced model - Free tier",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-cohere-free',
    label: 'Command A (Free)',
    description: "Cohere's command model - Free tier",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-kimi-free',
    label: 'Kimi K2 (Free)',
    description: "Moonshot AI's Kimi K2 - Free tier",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
